...
### Scenario A: The Input Array is Sorted
...
### Scenario B: The Input Array is Unsorted
...
- **Did you improve or change your approach?**
- **What is the time and space complexity of your solution?**
- **Sorted Version:** \* **Time Complexity:** $O(N)$ because it scans the array sequentially at most once.
- **Space Complexity:** $O(1)$ auxiliary space as it only uses pointers.

- **Unsorted Version:**
- **Time Complexity:** $O(N)$ because set insertion and lookup operations average $O(1)$ constant time.
